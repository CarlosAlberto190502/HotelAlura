...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		btnSalir.setBounds(754, 400, 83, 70);
		btnSalir.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
                            Object[] options = {"Aceptar", "Cancelar"};
                            
                            int opcion = JOptionPane.showOptionDialog(null, "En realidad quieres cerrar la aplicación?",
                                    "Cerrar Aplicación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
		...
		imagenSalir.setBounds(0, 0, 80, 70);
