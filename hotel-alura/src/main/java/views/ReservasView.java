...
public class ReservasView extends JFrame {
                ...
                txtFechaEntrada.addPropertyChangeListener(new PropertyChangeListener() {
                    ...
                    public void propertyChange(PropertyChangeEvent evt) {
                        if ("date".equals(evt.getPropertyName())) {
                            valor = reservaController.calcularDiferencia(txtFechaEntrada.getDate(), txtFechaSalida.getDate());
                            if(valor> 0){
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
                            if(reservaCreada != null){
                                ...
                                reservaCreada.setFechaEntrada(txtFechaEntrada.getDate());
                                reservaCreada.setFechaSalida(txtFechaSalida.getDate());
                                reservaCreada.setValor(valor);
                                reservaCreada.setFormaPago(txtFormaPago.getSelectedItem().toString());
                                reservaController.actualizarReserva(reservaCreada);
                                ...
                                if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {		
                                        int idRegistro = reservaController.crearReserva(new Reserva(
                                        ...
                                        registro.setIdReserva(idRegistro);
    ...
    public void setIdReserva(Reserva reserva){
        ...
        txtFechaEntrada.setDate(reservaCreada.getFechaEntrada());
        txtFechaSalida.setDate(reservaCreada.getFechaSalida());
        txtFormaPago.setSelectedItem(reservaCreada.getFormaPago());
