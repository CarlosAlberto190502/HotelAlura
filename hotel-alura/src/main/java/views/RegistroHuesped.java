...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
                            int resultado = 0; 
                            if(huespedCreada != null){
                                System.out.println("Editamos el Huesped");
                                huespedCreada.setNombres(txtNombre.getText());
                                huespedCreada.setApellidos(txtApellido.getText());
                                huespedCreada.setFechaNacimiento(txtFechaN.getDate());
                                huespedCreada.setNacionalidad(txtNacionalidad.getSelectedItem().toString());
                                huespedCreada.setTelefono(txtTelefono.getText());
                                resultado = new HuespedController().actualizarHuesped(huespedCreada);
                            }else{
                                resultado = new HuespedController().agregarHuesped(new Huesped(
                                                                        txtNombre.getText(), 
                                                                        txtApellido.getText(), 
                                                                        txtFechaN.getDate(), 
    ...
    public void setHuesped(Huesped huesped){
        this.huespedCreada = huesped;
        txtNombre.setText(huespedCreada.getNombres());
        txtApellido.setText(huespedCreada.getApellidos());
        txtFechaN.setDate(huespedCreada.getFechaNacimiento());
        txtNacionalidad.setSelectedItem(huespedCreada.getNacionalidad());
        txtTelefono.setText(huespedCreada.getTelefono());
        txtNreserva.setText(huespedCreada.getIdReserva()+"");
